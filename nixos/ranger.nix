...
#
#
#        # ranger-wrapper = pkgs.symlinkJoin {
#        #   name = "ranger";
#        #   paths = [ ranger-derivation ];
#        #   buildInputs = [ pkgs.makeWrapper ];
#        #   postBuild = ''
#        #     rm $out/share/doc/ranger/config/rc.conf
#        #     ln -s ${ranger-rc} $out/share/doc/ranger/config/rc.conf
#
#        #     wrapProgram $out/bin/ranger
#        #     #   --add-flags "--confdir=$out/config"
#        #   '';
#        # }; in
#
#  {
